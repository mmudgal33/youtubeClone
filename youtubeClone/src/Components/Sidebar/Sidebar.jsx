...
const Sidebar = ({sidebar,category,setCategory}) => {
  return (
    // dynamic class name use `` sidebar? means if side bar is true
    ...
    <div className="shortcut-links">
        ...
        <div className={`side-link ${category===31?"active":""}`} onClick ={()=>setCategory(31)}>
            <img src={news} alt="" /><p>Animation</p>
        </div>
        <div className={`side-link ${category===39?"active":""}`} onClick ={()=>setCategory(39)}>
    ...
    <div className="subscribed-list">
        ...
        <div className="side-link">
            <img src={cameron} alt="" /><p>Nass Dally</p>
        </div>
    </div>
    </div>
  )
